import { LinearRegressionService } from '../app/services/LinearRegressionService';
...
async function testCreateModel() {
    ...
    let result = await LinearRegressionService.createModel(event.body.data);
...
async function testGetModel() {
    let result = await LinearRegressionService.getModel(_id);
...
async function testTrainModel() {
    ...
    let result = await LinearRegressionService.trainModelFromCsv(event.body);
...
async function testDeleteModel() {
    let result = await LinearRegressionService.deleteModel(_id);
