  ...
  async uploadBuffer(
    ...
    return new Promise<string>(async (resolve, reject) => {
      ...
      writeStream.on("finish", async () => {
        ...
        resolve(
          `https://storage.googleapis.com/${this.bucketName}/${this.directory}/${filePath}`
        );
      });
    ...
    return new Promise<string>(async (resolve, reject) => {
      ...
      this.storage
        ...
        .then(async () => {
          ...
          resolve(
            `https://storage.googleapis.com/${this.bucketName}/${this.directory}/${destPath}`
          );
        })
        .catch((err) => {
          reject(err);
