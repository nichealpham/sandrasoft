...
import {ModelConfig as ConfigLinearRegressionModel, LinearRegressionModel} from '../../model/regression/LinearRegressionModel';
...
export class RegressionService {
    static trainLinearModel = async (input: {fileUrl: string, config?: ConfigLinearRegressionModel}) => {
        ...
        let model = new LinearRegressionModel(input.config);
